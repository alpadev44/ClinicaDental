window.addEventListener('load', function () {
    ...
    function findBy(id) {
          ...
          .then(data => {
              ...
              document.querySelector('#div_paciente_updating').style.display = "flex";
              document.querySelector('#div_paciente_updating').style.flexDirection = "column";
              document.querySelector('#div_paciente_updating').style.justifyContent = "center";
              document.querySelector('#div_paciente_updating').style.alignItems = "center";
